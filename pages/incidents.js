...
import { FormControlLabel, FormControl, FormLabel, FormGroup, Select, MenuItem, TextareaAutosize, InputLabel } from '@material-ui/core';
...
const incidents = () => {
    ...
    const body = (
        <div style={modalStyle} className={classes.paper}>
            ...
            <br></br>
            <FormControl>
                <TextareaAutosize minRows={3} style={{ minWidth: '20vw' }} placeholder="Relevant notes"/>
            </FormControl>
